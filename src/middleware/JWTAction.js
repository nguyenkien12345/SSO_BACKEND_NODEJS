...
const checkUserJWT = (req, res, next) => {
    ...
    if ((cookies && cookies.access_token) || tokenFromHeader) {
        // Chúng ta sẽ lấy access_token và refresh_token dựa vào cookie bởi vì chúng ta đã lưu 2 thằng 
        // này ở trong cookie và chúng ta không cho phép client thao tác được với cookie này, chúng ta
        // chỉ cho server thao tác thôi
